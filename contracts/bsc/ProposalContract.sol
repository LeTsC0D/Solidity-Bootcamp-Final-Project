...
contract ProposalContract {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner,"address is not the owner of contract");
        _;
    }

    modifier active() {
        require(proposal_history[_counter.current()].is_active == true,"proposal is not active");
        _;
    }
    ...
    modifier newVoter(address _address) {
        require(!isVoted(_address), "Address is not a new voter");
        _;
    }
